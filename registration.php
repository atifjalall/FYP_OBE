...
<style type="text/css">
  ...
  #reg{
    ...
    -webkit-box-shadow: 17px 17px 19.5px 11.5px #dddddd;
-moz-box-shadow: 17px 17px 19.5px 11.5px #dddddd;
box-shadow: 17px 17px 19.5px 11.5px #dddddd;
}
  h4{
    text-align: center;
    color:#ffffff;
...
<body>
     <div id="reg">
      ...
      <h2>Registration<br></h2><br>
        <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
        <div class="reg_ins">
        <table id="table">
          <tr>
            <td> <input type="text" name="name" class="n" required maxlength = "20" value="<?php if(isset($name)) echo $name;?>" placeholder="Enter name"></td><td class="error"><?php if(isset($errors['name'])) echo $errors['name'];?></td>
          </tr>
          <tr>
           <td> <input type="text" name="username" required maxlength = "20" value="<?php if(isset($nick_name)) echo $nick_name;?>" placeholder="Enter user name"></td>
           <td class="error"><?php if(isset($errors['username'])) echo $errors['username'];?></td>
          </tr>
          <tr>
            <td>
              <input type="text" name="dept" required maxlength = "20" value="<?php if(isset($dept)) echo $dept;?>" placeholder="Enter department name">
            </td>
          ...
          <tr>
            <td>
              <input type="text" name="email" required maxlength = "25" value="<?php if(isset($email)) echo $email;?>" placeholder="Enter email">
            </td>
          ...
          <tr>
            <td>
              <input type="password" name="con_pass" required value="" placeholder="Confirm password">
            </td>
          ...
          <tr>
            <td>
              <button type="submit" id="btn" name="submit"  class="btn btn btn-danger btn-md">Submit</buttom>
            </td>
            </tr>
            <tr>
            <td><div class="button" ><a href='index.php' class="btn btn-primary" id="btn">Back</a>
           </div></td>
            </tr>
        </table>
        </div>
