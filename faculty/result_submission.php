	...
	<div id="function">
		...
		<div style="width:80%; margin:0px auto ;">
		    ...
		    $sql = "SELECT *
                   ...
                   // echo("arg1.".$assigned_course_id);
                    //echo("ass_course_id".$ass_course_id);
                    $credit=$row["credit"];
					echo "<tr>";
...
?>
	...
	<div style="width:80%; margin:0px auto ;">
		...
		<div class="table-responsive">
			...
			<?php
				$sql =  "SELECT * FROM marks_component m join comp c where m.comp_id=c.comp_id and m.assigned_course_id='2'";
