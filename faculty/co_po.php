		...
		<div style="width:80%; margin:0px auto ;">
			...
			<?php
			 ...
			 $sql = "SELECT *
					...
					f.username='rockykhan' AND a.assigned_course_id='$id'";
	...
	?>
		<tr>
			...
			$sql3="SELECT * FROM assigned_course a JOIN mapping m join po p JOIN faculty f join co c
					WHERE a.assigned_course_id=m.assigned_course_id and f.faculty_id=a.faculty_id and m.po_id=p.po_id and m.co_id=c.co_id and  f.username='rockykhan' AND a.assigned_course_id='$id'";
