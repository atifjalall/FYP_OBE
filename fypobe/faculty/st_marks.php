	...
	<div id="function">
		...
		<div style="width:80%; margin:0px auto ;">
            ...
            <div class="table-responsive">
		     ...
		     $sql = "SELECT b.assigned_course_id,a.title,a.credit,b.semester,b.year,b.course_code,b.sec_no,b.username 
                    FROM course a INNER JOIN assigned_course b ON a.course_code = b.course_code WHERE 
                    b.username='$username' AND b.assigned_course_id='$id'";
			...
			if(isset($semester)&&isset($year))
				...
				if($result3=mysqli_query($connection,$sql3)){
			    	if(mysqli_num_rows($result3)>0){
			        	while ($row3 = mysqli_fetch_array($result3)){
			        		$component=$row3['component'];
				        	$sql4="SELECT a.course_outcome_id,b.id
