...
if(isset($_POST["Import"])){ 
 ...
 {
  $sq=" SELECT * FROM course c join offered_course o join assigned_course a WHERE c.course_id=o.course_id and o.offered_course_id=a.offered_course_id"; 
