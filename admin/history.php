...
<body class="body">
	...
	<div class="mainContent">
		...
		<center>
		    ...
		    $sql = "SELECT a.title,a.credit,c.semester,c.year,c.offered_course_code,c.sec_no,c.username,b.offered_course_code FROM course a JOIN offered_course b ON a.course_code = b.offered_course_code JOIN assigned_course c ON b.offered_course_code = c.offered_course_code WHERE c.username='$username'";
...
if(isset($_POST['add_1'])){
	   ...
	   // $sql1="SELECT * FROM student where course_code='$course_code'";
		$sql6="SELECT * FROM student where student_id='$select_id' AND grade IS NULL ";
	 ...
	 echo "<table class='table_1'border='1'>";
			...
			echo "</tr>";
	   	 	...
	   	 	$sql6="SELECT * FROM student where student_id='$select_id' AND grade IS NOT NULL";
		    if($result6=mysqli_query($connection,$sql6)){
			    if(mysqli_num_rows($result6)>0){
		        	while ($row6 = mysqli_fetch_array($result6)){
		        		$s_id=$row6['student_id'];
			        	$name=$row6['name'];
			        	$grade=$row6['grade'];
