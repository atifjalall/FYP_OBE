...
<div id="login">
  		...
  		<center>
			<table>
				<tr>
							...
							<td><input type="text" name="username" placeholder="Username" required value="<?php if(isset($username)) echo $username;?>"></td>
				...
				<tr>
							<td colspan="2"><input type="submit" id="btn" class="btn btn btn-danger btn-md"name="login" value="Log in"></td>
				</tr>
			</table>
	...
	<br>
	<br>
	<p id="new">Not a Registered Faculty? <br> <a href="registration.php">Sign Up</a> here. </p>
	</center>
</div>
</body>
</html>
